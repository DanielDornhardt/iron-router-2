...
/**
 * Go to a given path or route name, optionally pass parameters and options.
 *
 * Example:
...
Router.prototype.go = function (routeNameOrPath, params, options) {
  ...
  if (isPath.test(routeNameOrPath)) {
    ...
    path = __meteor_runtime_config__.ROOT_URL_PATH_PREFIX + route.path(params, _.extend(options, {throwOnMissingParams: true}));
  }
